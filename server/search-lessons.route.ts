...
export function searchLessons(req: Request, res: Response) {
    ...
    const courseId: number = parseInt(queryParams.courseId as string),
          filter: string = (queryParams.filter as string) || '',
          sortOrder = queryParams.sortOrder,
          pageNumber: number = parseInt(queryParams.pageNumber as string) || 0,
          pageSize: number = parseInt(queryParams.pageSize as string);
